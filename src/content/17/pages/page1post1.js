...
const page1post1 = () => {
    return (
        <Main>
            ...
            <a href="https://github.com/Perpaterb/HaalandVsMbappe"  target="_blank" >Github</a>
            <br/>
            <h1>2. First React app.  Reacting in React.</h1>
            <p>Just a simple click training game</p>
            <a href="https://reacting-in-react.herokuapp.com/"  target="_blank" >Reacting in React</a>
            <a href="https://github.com/Perpaterb/Reacting-in-React"  target="_blank" >Github</a>
        </Main>
    )
}
